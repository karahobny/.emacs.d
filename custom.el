(custom-set-variables
 ...
 '(cider-mode-line (quote (:eval (format " repl "))))
 ...
 '(package-selected-packages
   (quote
    (smooth-scrolling suggest spaceline-all-the-icons all-the-icons-gnus all-the-icons-dired neotree helm-google cyphejor dim exwm-x exwm pdf-tools prettify-symbols delight em-smart file doom-themes auto-compile which-key use-package company-distel erlang tuareg sml-mode diminish airline-themes paradox shrink-path w3m smart-mode-line-powerline-theme smart-mode-line flycheck-haskell eshell-bookmark eshell-prompt-extras comment-dwim-2 punpun-theme pretty-mode nlinum-relative flylisp flycheck-clojure flycheck flycheck-checkbashisms helm-core parinfer org-download company clojure-mode-extra-font-locking clj-refactor centered-cursor-mode ampc alchemist aggressive-indent emms-player-mpv ace-window xkcd pelican-mode org-bullets nov mingus typo twittering-mode sx sicp 4clojure hackernews paredit esh-autosuggest company-shell company-go xresources-theme slime-company spiral window-jump rc-mode undo-tree smart-comment slime magithub magit cider chicken-scheme align-cljlet scheme-complete sudo-edit nlinum minimap xclip)))
...
(custom-set-faces
 ...
 '(mode-line ((t (:background "#1b2229" :foreground "#5b6268"))))
 '(mode-line-inactive ((t (:background "#202328" :foreground "#5b6268"))))
 '(powerline-active1 ((t (:background "#1b2229" :foreground "#73797e"))))
 '(powerline-active2 ((t (:background "#1b2229" :foreground "#5b6268"))))
 '(powerline-inactive1 ((t (:background "#202328" :foreground "#5b6268"))))
 '(powerline-inactive2 ((t (:background "#202328" :foreground "#5b6268"))))
 '(spaceline-highlight-face ((t (:background "#2257a0" :foreground "#5bbc2c"))))
 '(window-divider ((t (:foreground "#222222"))))
 '(window-divider-first-pixel ((t (:foreground "#222222"))))
 '(window-divider-last-pixel ((t (:foreground "#222222")))))
